...
public class ChamadoService {
	...
	public List<Chamado> findByStatusintergrallAndSubmotivo_SincronismoAndSubmotivo_Equipe(String status_intergrall, boolean sincronismo, String equipe) {
		log.info("Buscar lista de chamados para sincronismo");
		return repository.findByStatusintergrallAndSubmotivo_SincronismoAndSubmotivo_Equipe(status_intergrall, sincronismo, equipe);
	}
