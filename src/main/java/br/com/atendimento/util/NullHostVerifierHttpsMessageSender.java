...
public class NullHostVerifierHttpsMessageSender extends HttpsUrlConnectionMessageSender {

	private NullHostnameVerifier _hostnameVerifier;
	private SSLSocketFactory _sslSocketFactory;

	public NullHostVerifierHttpsMessageSender() throws NoSuchAlgorithmException, KeyManagementException {
